...
public class SecondActivity {
	...
	public static void main(String[] args) {
		Person oldPerson = readPerson("Workshop/files-activity-2/src/resources/input/person.bin");
		writeNewPerson("Workshop/files-activity-2/src/resources/output/new-person.ddr", oldPerson);
		System.out.println(oldPerson);
		Person newPerson = readNewPerson("Workshop/files-activity-2/src/resources/output/new-person.ddr");
